...
export class PDFExportService {
  ...
  private resetDocument(): void {
    ...
    // Setup modern fonts and styling
  ...
  private addModernHeader(session: SessionData): void {
    ...
    this.pdf.text('AI-Powered Speech Analysis Report', 20, 32);
    
    // Session info on the right with better alignment
    this.pdf.setFontSize(11);
    this.pdf.setFont('helvetica', 'bold');
    this.pdf.setTextColor(255, 255, 255);
    ...
    this.pdf.text(sessionText, this.pageWidth - 20, 20, { align: 'right' });
    
    this.pdf.setFontSize(9);
    this.pdf.setFont('helvetica', 'normal');
    this.pdf.setTextColor(203, 213, 225); // Muted text
    this.pdf.text(dateText, this.pageWidth - 20, 28, { align: 'right' });
  }
