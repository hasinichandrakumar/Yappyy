          ...
          <div className="flex justify-between items-center h-16">
            ...
            <div className="flex items-center space-x-4">
              {!isAuthenticated ? (
                ...
                >
                  <div className="flex items-center space-x-2 bg-gradient-to-r from-blue-500 to-purple-600 p-1 rounded-lg">
                    <img src={yappyyLogoPath} alt="Yappyy" className="h-5 w-5 bg-white rounded p-0.5" />
                    <span className="text-white font-medium">Yappyy</span>
                  </div>
